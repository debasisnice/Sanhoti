...
// For mobile app: Always use production API URL
// Can be overridden with VITE_API_URL environment variable for development
const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://www.sanhoti.org/api';
